...
export default function Sidebar({ active, onNavigate, mobileOpen, onCloseMobile }: Props) {
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-gray-200 bg-white shadow-[4px_0_24px_rgba(0,0,0,0.02)] transition-[transform,background-color,border-color] duration-300 dark:border-white/5 dark:bg-slate-950/80 dark:shadow-none dark:backdrop-blur-xl lg:translate-x-0 ${
